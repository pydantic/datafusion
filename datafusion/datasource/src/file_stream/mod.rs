...
mod tests {
    ...
    impl FileStreamMorselTest {
        ...
        /// Adds one file to partition 0.
        fn with_file(self, planner: MockPlanner) -> Self {
        ...
        fn with_file_in_partition(
            ...
            self.partition_files
                .entry(partition)
                .or_default()
                .push(planner.file_path().to_string());
