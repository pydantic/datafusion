...
pub trait PhysicalExpr: Any + Send + Sync + Display + Debug + DynEq + DynHash {
    ...
    ///
    /// [`PhysicalExprNode`]: datafusion_proto_common::protobuf::PhysicalExprNode
    #[cfg(feature = "proto")]
    fn to_proto(
        &self,
...
///
/// [`PhysicalExprEncodeCtx`]: proto_encode::PhysicalExprEncodeCtx
/// [`PhysicalExprEncode`]: proto_encode::PhysicalExprEncode
#[cfg(feature = "proto")]
pub mod proto_encode {
    use std::sync::Arc;

    use datafusion_common::Result;
    use datafusion_proto_common::protobuf::PhysicalExprNode;
...
///
/// [`PhysicalExprDecodeCtx`]: proto_decode::PhysicalExprDecodeCtx
#[cfg(feature = "proto")]
