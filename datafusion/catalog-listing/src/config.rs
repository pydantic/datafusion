...
///
/// If not specified, a default physical expression adapter factory will be used,
/// which handles basic schema compatibility cases.
...
impl ListingTableConfig {
    ...
    ///
    /// If not provided, a default physical expression adapter factory will be used.
