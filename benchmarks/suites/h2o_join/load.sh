...
# Idempotent data loader for the h2o_join benchmark suite.
...
if [ -f "${DATA_DIR}/J1_1e7_NA_0.csv" ]; then
    echo "H2O join data already exists at ${DATA_DIR}"
    exit 0
fi

echo "Generating H2O join data..."
